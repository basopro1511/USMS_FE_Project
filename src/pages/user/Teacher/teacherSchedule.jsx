...
import { getScheduleForTeacher } from "../../../services/scheduleService";
...
const TeacherSchedule = () => {
  ...
  useEffect(() => {
    ...
    if (filterData.teacherId && filterData.startDay && filterData.endDay) {
      // Đặt loading về true và reset error mỗi khi fetch dữ liệu mới
      setLoading(true);
      const fetchScheduleData = async () => {
        try {
          const scheduleRes = await getScheduleForTeacher(
  ...
  }, [filterData.teacherId, filterData.startDay, filterData.endDay]);
