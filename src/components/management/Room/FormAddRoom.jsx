...
function FormAddRoom() {
    ...
    const [newRoom, setNewRoom] = useState({ // tạo 1 model đễ lấy dữ liệu từ api
        roomId: "",
        location: "",
        isOnline: false,
        onlineURL: null,
    ...
    const handleAddRoom = async (e) => {
        ...
        try {
            const response = await AddRoom(newRoom); // Gọi API thêm phòng
                        ...
                        <div>
                            ...
                            <form onSubmit={handleAddRoom}>
                                <input
                                    ...
                                    className="w-full max-w-[500px] h-[50px] text-black border border-black rounded-xl mt-8 px-4"
                                    onChange={(e) =>
                                ...
                                <input
                                    ...
                                    required
                                    placeholder="Vị trí"
                                    className="w-full max-w-[500px] h-[50px] text-black border border-black rounded-xl mt-6 mb-6 px-4"
                                    onChange={(e) =>
