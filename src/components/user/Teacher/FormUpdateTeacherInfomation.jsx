...
function FormUpdateTeacherPersonalInformation({ infoToUpdate, onReaload }) {
  ...
  const handleUpdateTeacher = async (e) => {
    ...
    try {
      ...
      const response = await UpdateTeacher(updatedStaff);
...
export default FormUpdateTeacherPersonalInformation;
